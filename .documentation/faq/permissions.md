 ...
 * privacy: this permission is needed to read if the user has privacy.resistFingerprinting enabled. A notice about a slightly changed behaviour of anti-print is displayed in the settings page in that case.